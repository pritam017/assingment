<div class="br-logo"><a href="{{route('welcome')}}"><span>[</span>bracket <i>plus</i><span>]</span></a></div>
    <div class="br-sideleft sideleft-scrollbar">
      <label class="sidebar-label pd-x-10 mg-t-20 op-3">Navigation</label>
      <ul class="br-sideleft-menu">
        <li class="br-menu-item">
        <a href="{{Auth::user()->role->id == 1 ? route('backend.admin.dashboard'):route('backend.customer.dashboard')}}" class="br-menu-link active">
     ...
     <li class="br-menu-item">
          ...
          <li class="sub-item"><a href="{{route('backend.admin.manageCat')}}" class="sub-link">All Category</a></li>
          <li class="sub-item"><a href="{{route('backend.admin.createCat')}}" class="sub-link">Add New Category</a></li>
          </ul>
        </li>
        ...
        <li class="br-menu-item">
            ...
            <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('backend.admin.manageBrand')}}" class="sub-link">All Brand</a></li>
            <li class="sub-item"><a href="{{route('backend.admin.createBrand')}}" class="sub-link">Add New Brand</a></li>
            </ul>
          </li>
   ...
   <li class="br-menu-item">
    ...
    <ul class="br-menu-sub">
    <li class="sub-item"><a href="{{route('backend.admin.manageProduct')}}" class="sub-link">All Product</a></li>
    <li class="sub-item"><a href="{{route('backend.admin.createProduct')}}" class="sub-link">Add New Product</a></li>
    </ul>
  </li>
   ...
   <li class="br-menu-item">
    ...
    <ul class="br-menu-sub">
    <li class="sub-item"><a href="{{route('backend.admin.manageDivision')}}" class="sub-link">All Division</a></li>
    <li class="sub-item"><a href="{{route('backend.admin.createDivision')}}" class="sub-link">Add New Division</a></li>
    </ul>
  </li>
   ...
   <li class="br-menu-item">
    ...
    <ul class="br-menu-sub">
    <li class="sub-item"><a href="{{route('backend.admin.manageDistrict')}}" class="sub-link">All District</a></li>
    <li class="sub-item"><a href="{{route('backend.admin.createDistrict')}}" class="sub-link">Add New District</a></li>
    </ul>
  </li>
  @endif
